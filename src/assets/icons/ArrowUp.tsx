...
export default function ArrowUp({ active = false }: ArrowUpProps) {
  return (
    <svg width="12" height="20" viewBox="0 0 15 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <mask
        id="mask0_982_788"
      ...
      <g mask="url(#mask0_982_788)">
        <path
          ...
          fill={active ? interactions.active : '#424242'}
        />
      </g>
    </svg>
  );
