...
export default function ArrowRightPilot({ status }: ArrowRightPilotInterface) {
  return (
    <svg width="3.35" height="5.11" viewBox="0 0 4 6" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
