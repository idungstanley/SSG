...
export default function Row({ teamMemberId }) {
  ...
  const removeTeamMemberConfirmation = () => {
    dispatch(displayPrompt('Remove team member', 'Would you like to remove this team member from the workspace?', [
      {
  ...
  const deactivateTeamMemberConfirmation = () => {
    dispatch(displayPrompt('Deactivate team member', 'Would you like to deactivate this team member? They will no longer be able to access this workspace. You can reactivate the team member in the future.', [
      {
  ...
  const reactivateTeamMemberConfirmation = () => {
    dispatch(displayPrompt('Reactivate team member', 'Would you like to reactivate this team member?', [
      {
            ...
            items={[
              {
                ...
                onClick: () => (teamMember.is_active ? deactivateTeamMemberConfirmation() : reactivateTeamMemberConfirmation()),
