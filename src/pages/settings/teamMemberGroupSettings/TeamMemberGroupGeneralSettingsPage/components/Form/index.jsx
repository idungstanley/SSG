...
export default function Form() {
  ...
  const deleteGroupConfirmation = () => {
    dispatch(displayPrompt('Delete group', 'Would you like to delete this group?', [
      {
        label: 'Delete group',
        style: 'danger',
        callback: async () => {
          await deleteTeamMemberGroupMutation.mutate({
            teamMemberGroupId,
          });
        },
      },
        ...
        <div>
          <div>
            ...
            <p className="mt-1 max-w-2xl text-sm text-gray-500">
              Manage team member group general settings
            </p>
          </div>
