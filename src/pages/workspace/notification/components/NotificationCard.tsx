...
export default function NotificationCard({ cardItems }: never[]) {
  return (
    <>
      {Object.keys(cardItems).map((key) => (
        <div key={cardItems[key].key}>
          <main className="mx-40 mt-10 flex flex-col -my-2 overflow-x-auto">
            <div className="inline-block min-w-full py-2 align-middle border border-gray-200 p-2 rounded-md bg-gray-100 mb-2 pb-4 md:px-6 lg:px-6">
              <p className="capitalize font-bold mb-1 text-xs">
                {cardItems[key].key}
              </p>
              <div className="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                <div className="min-w-full">
                  {cardItems[key].notifications.map(
                          ...
                          <div>
                            ...
                            >
                              <p className="text-xs border border-gray-200 rounded-md px-3">
                                Community &gt; support | HR &gt; Ticket Support
                                | HR
                              </p>
                            </div>
