...
export default function Search() {
  ...
  return (
    <>
      ...
      >
        <div
          className="absolute right-0 flex items-center justify-between w-auto tracking-wider text-gray-400 left-4 top-3 hover:text-primary-400"
          style={{ fontSize: '9px' }}
        >
        ...
        <input
          placeholder=""
          className="w-full pl-8 border-gray-400 rounded-2xl h-7 group-hover:border-primary-400 group-hover:text-primary-400"
          disabled
          type="text"
        />
      </button>
