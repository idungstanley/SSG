  ...
  return (
    <div
      className={cl(
        ...
        directoryId === id ? 'hover:bg-green-200 bg-green-100' : 'hover:bg-gray-100'
      )}
    >
      <div onClick={() => onClickDirectory(id)} className="flex truncate items-center gap-2 cursor-pointer">
        {directoryId === id ? (
