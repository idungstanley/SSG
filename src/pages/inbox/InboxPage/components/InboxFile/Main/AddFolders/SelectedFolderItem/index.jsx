...
function SelectedFolderItem({
  ...
  return folder ? (
    <Tippy content={<span>{folder.full_path}</span>} maxWidth={1000}>
      <span key={folder.id} className="cursor-pointer inline-flex rounded-full items-center py-1 mr-1 pr-3.5 pl-1.5 mb-1.5 text-sm font-medium bg-indigo-100 text-indigo-700 select-none">
        <button
          type="button"
