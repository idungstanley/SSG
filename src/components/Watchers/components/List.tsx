...
import { useGetItemWatchers, useRemoveWatcher } from '../../../features/general/watchers/watchersService';
      ...
      <div>
        ...
        <ul role="list" className="divide-y divide-gray-200">
          {watchers.map((watcher) => (
            <li key={watcher.id} className="flex py-4 w-full items-center justify-between">
              <div className="flex">
                <AvatarWithInitials
                ...
                <div className="ml-3">
                  <p className="text-sm font-medium text-gray-900">{watcher.team_member.user.name}</p>
                  <p className="text-sm text-gray-500">{watcher.team_member.user.email}</p>
                </div>
              </div>
