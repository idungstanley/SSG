...
function InputAvatar({ size, upload, action }: inputAvatarType) {
  return (
    <div className="flex items-center justify-center rounded-full">
      <label
        htmlFor="avatar-file"
        className="flex flex-col items-center justify-center border-2 border-gray-300 border-dashed rounded-full cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600"
