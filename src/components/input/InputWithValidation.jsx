  ...
  return (
    <div className="relative">
      ...
      <div className="absolute top-8 left-2">
        ...
        >
          <path
            ...
            d={label === 'email' ? icons[1].path : icons[0].path}
          />
        </svg>
      </div>
      ...
      <input
        ...
        } rounded-md shadow-sm placeholder-gray-500 focus:outline-none focus:${message ? 'ring-red-700' : 'ring-gray-300'} focus:${message ? 'border-red-700' : 'border-gray-300'} sm:text-sm`}
        id={id}
        type={type}
