...
//     setHeaders((prev) => prev.map((header) => (header.value === col ? { ...header, hidden: !header.hidden } : header)));
...
//                         </li>
//                         {headers.map((header) => (
//                           <ColumnFilterList key={header.value} handleColumnHide={handleColumnHide} header={header} />
//                         ))}
//                       </ul>
//                     </div>
//                   )}
