...
//     { title: 'user', hidden: false, value: 'team_member_id', sorted: false },
//     { title: 'duration', hidden: false, value: 'duration', sorted: false },
//     { title: 'start date', hidden: false, value: 'start_date', sorted: false },
//     { title: 'end date', hidden: false, value: 'end_date', sorted: false },
//     { title: 'description', hidden: true, value: '', sorted: false }
//   ]);
