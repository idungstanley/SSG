    ...
    <div className="w-full">
      <button className="w-full flex items-center justify-between h-full" onClick={handleClick}>
        <div className="flex items-center">
          ...
          <p className="text-alsoit-gray-300-lg text-alsoit-text-lg font-semibold">People</p>
        </div>
        <ArrowRight />
      </button>
      <Menu
      ...
      >
        <div key="peopleOptions">
          <div className="w-full mt-2 flex justify-center">
            <h1 className="text-alsoit-text-lg font-semibold">PEOPLE</h1>
          </div>
          <hr />
