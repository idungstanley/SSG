    ...
    <div className="w-full px-2 pl-1">
      <button className="flex items-center justify-between w-full h-full" onClick={handleClick}>
        <div className="flex items-center">
          ...
          <p className="font-semibold text-alsoit-gray-300-lg text-alsoit-text-lg">Formula</p>
        </div>
        <ArrowRight />
      </button>
      <Menu
      ...
      >
        <div key="formulaOptions">
          <div className="flex justify-center w-full mt-2">
            <h1 className="font-semibold text-alsoit-text-lg">FORMULA</h1>
          </div>
          <hr />
