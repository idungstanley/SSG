...
export default function BlinkerModal() {
  ...
  const { activeTabId, workSpaceId, hubId, listId, taskId, viewId } = recorderLastMemory as IRecorderLastMemory;
  ...
  return (
    <div className="flex flex-col w-full">
      <span
        ...
        onClick={() => dispatch(resetWorkSpace({ activeTabId, workSpaceId, hubId, listId, taskId, viewId }))}
      >
